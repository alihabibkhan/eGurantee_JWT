...
def api_kft_distribution_crud(distribution_id=None):
    ...
    if not (is_admin() or is_executive_approver() or PermissionHelper.has_permission(get_current_user_id(), "/add-kft-distribution") or PermissionHelper.has_permission(get_current_user_id(), "/delete-kft-distribution")):
